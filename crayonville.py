...
def run():
    ...
    if st.session_state.progress == 0:
        ...
        st.markdown('<div style="font-size:20px;">The <b>journey</b> that you've chosen reveals your <b>thinking style.</b> Understanding it helps you to adapt to the use of the design thinking spell effectively."</div>', unsafe_allow_html=True)
